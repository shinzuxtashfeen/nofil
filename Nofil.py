...
def started():
    ...
    print('%s╠══[%s•%s] %sAccount [OK] Saved To NOFIL-OK/%s.txt'%(O,P,O,P,tanggal))
    print('%s╠══[%s•%s] %sAccount [CP] Saved To NOFIL-CP/%s.txt'%(O,P,O,P,tanggal))
